...
for agent in TOP_AGENTS:
    ...
    # Process the first 20 tasks from all_preds.jsonl
    with open(all_preds_path, 'r') as f:
        for i, line in enumerate(f):
            ...
            try:
                data = json.loads(line.strip())  # Added strip() to remove any whitespace
                ...
                print(f"Skipping invalid JSON format in line: {line}")
